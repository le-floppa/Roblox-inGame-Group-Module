...
Honestly I have no idea what to name this
...
# [Features] (Planed) 
- Replaces the need for Groups
- Auto Promotes people in Discord (if set up)
- Officers can award XP to people ingame with set safety procautions (no spam giving xp)
- Generals can promote and demote (can be disabled)
- highly customizable
- easy to setup
